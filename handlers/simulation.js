...
const productDetail = {
  ...
  consumer_disbursement_requirements: ["INVOICE", "DELIVERY", "DOWN_PAYMENT"],
  provider_disbursement_requirements: [],
};

const getDownPaymentInAmount = (downPaymentAmount, orderPrice) => {
...
const getDownPaymentOverAmount = (downPayment, orderAmount, loanRange) => {
...
const calculateDownPayment = (
  ...
  if (isInAmountType) {
    ...
    return getDownPaymentOverAmount(downPayment, orderAmount, {
      maxLoanAmountValue,
      minLoanAmountValue,
    });
  }
...
const createPaymentTerm = (term, totalAmount) => {
  return {
